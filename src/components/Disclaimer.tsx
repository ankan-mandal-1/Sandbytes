        ...
        >
          ...
          <div className="space-y-12 text-zinc-600 leading-relaxed">
            <section className="p-8 bg-zinc-50 rounded-[32px] border border-black/5">
              ...
              <p>While we take pride in helping startups raise capital and scale, Sandbyte Studio does not guarantee specific financial outcomes, funding success, or specific Google search rankings. Business success depends on market variables beyond our control.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-zinc-900 mb-4">Third-Party Tools</h2>
              <p>We use industry-standard tools like Framer, Webflow, and Vercel. Sandbyte Studio is not responsible for service outages, price changes, or data breaches occurring on these third-party platforms.</p>
            </section>
            ...
            <div className="pt-12">
              <a href="mailto:hello@sandbyte.studio" className="text-zinc-900 font-bold underline decoration-zinc-300 underline-offset-8">
